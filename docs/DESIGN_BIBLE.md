...
La référence Standard ne vise donc plus un nombre arbitraire de mois de survie structurelle. Elle doit permettre plusieurs trajectoires raisonnables vers un premier CPU industrialisé tout en rendant coûteux les retards, les choix trop ambitieux et les dépenses prématurées. Le playtest V0.6 de référence observe 4 452 € de dépenses au premier mois sur un brief simple, pour 95 548 € de trésorerie restante.
