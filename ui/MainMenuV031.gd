...
func _show_settings() -> void:
	...
	_add_audio_slider("Volume général", "master_volume")
	_add_audio_slider("Ambiance / musique", "music_volume")
	_add_audio_slider("Effets et interface", "sfx_volume")
